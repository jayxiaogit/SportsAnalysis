def InternationalEarnings(inputRanking):
    import pandas as pd
    ...
    for index, row in df.iterrows():
        ...
        if col_1_value == "W":
            ...
            new_rank = random.randint(58000, 60000)
        elif col_1_value == "SF":
            new_rank = random.randint(34000, 36000)
        elif col_1_value == "QF":
            new_rank = random.randint(19000, 21000)
        elif col_1_value == "R16":
            new_rank = random.randint(11000, 12000)
        elif col_1_value == "R32":
            new_rank = random.randint(7000, 8000)
        elif col_1_value == "R64":
            new_rank = random.randint(3500, 3600)
        elif col_1_value == "R128":
            new_rank = random.randint(1900, 1950)
