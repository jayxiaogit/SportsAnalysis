def PMEarnings(inputRanking):
    ...
    df = pd.read_csv("PremierMandatory.csv")
    ...
    for index, row in df.iterrows():
        ...
        if col_1_value == "W":
            new_rank = random.randint(1000000, 1200000)
        elif col_1_value == "F":
            new_rank = random.randint(585000, 600000)
        elif col_1_value == "SF":
            new_rank = random.randint(325000, 350000)
        elif col_1_value == "QF":
            new_rank = random.randint(185000, 200000)
        elif col_1_value == "R16":
            new_rank = random.randint(100000, 110000)
        elif col_1_value == "R32":
            new_rank = random.randint(59000, 60000)
        elif col_1_value == "R64":
            new_rank = random.randint(42000, 44000)
        elif col_1_value == "R128":
            new_rank = random.randint(30000, 31000)
        elif col_1_value == "Q2":
            new_rank = random.randint(14000, 15000) #this is not accurate
