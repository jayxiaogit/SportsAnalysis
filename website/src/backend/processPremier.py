def PremierEarnings(inputRanking):
    import pandas as pd
    ...
    for index, row in df.iterrows():
        ...
        if col_1_value == "W":
            new_rank = random.randint(500000, 520000)
        elif col_1_value == "F":
            new_rank = random.randint(238800, 250000)
        elif col_1_value == "SF":
            new_rank = random.randint(127000, 130000)
        elif col_1_value == "QF":
            new_rank = random.randint(65000, 67000)
        elif col_1_value == "R16":
            new_rank = random.randint(34000, 36000)
        elif col_1_value == "R32":
            new_rank = random.randint(17000, 19000)
        elif col_1_value == "R64":
            new_rank = random.randint(9489, 10000)
        elif col_1_value == "R128":
            new_rank = random.randint(5000, 6000)
