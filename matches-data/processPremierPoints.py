...
for index, row in df.iterrows():
    ...
    rank = row[0]
    #if rank >= 800: this line is probably unnecessary here
    #    continue 
    ...
    #TODO: this needs adjusting because of diff format
    if col_1_value == "W":
        new_rank = 470
    elif col_1_value == "F":
        new_rank = 305
